...
my $duration = tv_interval $start, $end1;
$save_file->append_utf8("Duration of first move is $duration\n");
...
#my $return2=$save_file->append_utf8(`dd @players`);
#say "return2 is $return2";
...
while (1) {
  ...
  my $return3 = $save_file->append_utf8("Current player is $current\n");
  ...
  for my $flip ( 0, 1 ) {
    ...
    say "flip is $flip";
    my $return5 = $save_file->append_utf8("Board is \n$board\n");
    say "return5 is $return5";
    $return5 = $save_file->append_utf8("Heights is \n$heights\n");
    say "return5 is $return5";
    ...
    $save_file->append_utf8("patterns----------------\n");
    #$save_file->append_utf8(`dd @pat\n`);
...
## end of turn
  ...
  my $duration = tv_interval $end1, $end2;
  $save_file->append_utf8("Duration of move $moves is $duration\n");
