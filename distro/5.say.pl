...
$save_file->append_utf8(dd \@players);
...
while (1) {
  ...
  #  dd @pat;
say "looping over board patterns";
    for (@pat) {
      my ( $pos, $pat ) = @$_;
say "default is @$_";
...
say "words are @words";
#say "subdict is  @subdict"; #verbose as heck
